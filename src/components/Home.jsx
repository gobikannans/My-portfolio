    ...
    <main name="Home" className='h-screen w-full  flex flex-col justify-center items-center bg-gradient-to-b from-black via-black to-gray-900'>
        <section className='max-[451px]:px-[20px] px-[30px] pr-[0px] md:px-[60px] lg:px-[60px] xl:px-[100px] flex flex-row  justify-center items-center w-[100%] h-full max-[1680px]:justify-between max-[1719px]:w-[100%]'>
          <div className='flex flex-col justify-center items-start w-[100%] min-[1000px]:h-full max-[450px]:mt-20' >
            <h1 className='text-slate-500 font-bold max-[450px]:text-[27px] text-[35px] sm:text-[35px]'>Hello !</h1>
            <h1 className=' text-slate-500 max-[450px]:text-[26px] text-[35px] mt-[10px] sm:text-[35px] font-bold font-Roboto '>I'm <span className='text-blue-500'> Gobi Kannan</span> </h1>
            <h2 className=' text-slate-500 max-[450px]:text-[26px] text-[35px] mt-[20px] sm:text-[35px] font-bold '> I'm a<span className='text-blue-500 '>  Front-End Developer</span></h2>
          ...
          <Link to="Contact" offset={-60}  smooth duration={800}>
            <button className='hidden max-[1024px]:flex max-[450px]:py-3 max-[640px]:text-[26px] max-[640px]:py-4 max-[640px]:w-[150px] max-[450px]:w-[110px]  max-[450px]:text-[18px] items-center w-[150px] mt-[30px] py-3 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-md text-white text-[23px] justify-center'>Hire Me
